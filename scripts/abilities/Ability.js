...
public function name(Ability) extends Cloneable{
    ...
    public function name(display(Table.t)){
    ...
    public function name(addStats(Table.t)){
    ...
    public function name(abilityStats(String.stat, Object... values){
        return Core.bundle.format("ability.stat." + stat, value);
    }

    public function Ability name(copy()){
        try{
    ...
    public function name(localized){
        return Core.bundle.get(getBundle());
    }

    public function name(getBundle){
        var type = getClass();
